...
setup(
    name=conguide.__prog__,

    # Versions should comply with PEP440.  For a discussion on single-sourcing
    # the version across setup.py and the project code, see
    # https://packaging.python.org/en/latest/single_source_version.html
    version=conguide.__version__,

    description='Scripts to create a "Convention Guide" or "Pocket Program"',
    ...
    entry_points={
        'console_scripts': [
            'conguide=conguide.conguide:main',
        ],
        'setuptools.installation': [
            'eggsecutable = conguide.conguide:main',
        ]
    },
)
